			...
			<div class="well">
				...
				<div class="pagination pagination-right">
					<ul>
						...
						<li>
							<a href="PaperServlet?obj=selectAll&pageNo=${pageModel.prePage }">上一页</a>
						</li>						
						
						<li>
							<a href="PaperServlet?obj=selectAll&pageNo=${pageModel.nextPage }">下一页</a>
						</li>
						<li>
							<a href="PaperServlet?obj=selectAll&pageNo=${pageModel.totalPage }">末页</a>
						</li>
					</ul>
				</div>
			</div>
