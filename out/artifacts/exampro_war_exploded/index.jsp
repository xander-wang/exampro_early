...
<body style="background-color:#f2f9fd;">
    <div class="header bg-main">
        ...
        <div class="head-l">
            <a href="javascript:void(0);" class="button button-little bg-blue"><span class="icon-user"></span> ${user.getUsertruename()}(${user.getRolename()})</a> &nbsp;&nbsp;
    ...
    <div class="leftnav">
        ...
        <ul id="error-menu" class="nav nav-list collapse" style="display:block">
             <li>
                 <a href="" target="right"><span class="icon-caret-right"></span>系统功能管理</a>
             </li>
             <li>
                 <a href="" target="right"><span class="icon-caret-right"></span>用户管理</a>
             </li>
             <li>
                 <a href="" target="right"><span class="icon-caret-right"></span>角色管理</a>
             </li>
        </ul>
        <h2><span class="icon-briefcase"></span>试题管理</h2>
        <ul id="error-menu" class="nav nav-list collapse" style="display:block">
             <li>
                 <a href="SubjectServlet?obj=selectAll" target="right"><span class="icon-caret-right"></span>题目管理</a>
             </li>
             <li>
                 <a href="" target="right"><span class="icon-caret-right"></span>试卷管理</a>
             </li>
        </ul>
    </div>
